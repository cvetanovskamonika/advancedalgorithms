...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $title ?? 'Advanced Algorithms' }}</title>
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header class="flex flex-col md:flex-row items-center justify-between px-8 py-4">
            <a href="/"><img src="{{ asset('img/logo.png') }}" alt="logo" width="220" height="50"></a>
      ...
      ">
                    ...
                    <h3 class="font-semibold text-base">Add an algorithm</h3>
                    <p class="text-xs mt-4">
                        @auth
                        Create your own or add an existing algorithm you find useful.
                        @else
                        Please login to add an algorithm.
                        @endauth
                    </p>
                    </div>
