    ...
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="other_filters" id="other_filters" class="w-full rounded-xl border-none px-4 py-2">
                ...
                <option value="My Ideas">My Algorithms</option>
                @admin
                    <option value="Spam Ideas">Spam Algorithms</option>
                    <option value="Spam Comments">Spam Comments</option>
                @endadmin
            </select>
        </div>
        <div class="w-full md:w-2/3 relative">
            <input wire:model="search" type="search" placeholder="Find an algorithm" class="w-full rounded-xl bg-white border-none placeholder-gray-900 px-4 py-2 pl-8">
    ...
    <div class="ideas-container space-y-6 my-8">
        @forelse ($ideas as $idea)
            ...
            <img src="{{ asset('img/no-ideas.svg') }}" alt="No Ideas" class="mx-auto mix-blend-luminosity">
                <div class="text-gray-400 text-center font-bold mt-6">No algorithms were found...</div>
            </div>
        @endforelse
